...
const Storage = {
  ...
  set(key, data) {
    try {
      ...
      if (e && (e.name === 'QuotaExceededError' || e.code === 22)) {
        alert('Memória do app cheia (fotos grandes). Apague fotos antigas ou limpe dados do site.');
      }
      return false;
    }
  },
  ...
  getTabelaMedidas() {
    // Compat: se for objeto antigo único, converte pra lista
    try {
  ...
  saveTabelaMedidas(lista) {
    localStorage.setItem(this.KEYS.tabelaMedidas, JSON.stringify(lista || []));
  },
